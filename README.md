...
```mermaid
graph TD
    A[Lines of Code] --> B[Total: 15,432];
    A --> C[TypeScript: 8,245];
    A --> D[CSS: 4,321];
    A --> E[Tests: 2,866];
```
...
| [<img src="https://github.com/user1.png" width="50px;"/><br /><sub><b>Nombre 1</b></sub>](https://github.com/user1) | [<img src="https://github.com/user2.png" width="50px;"/><br /><sub><b>Nombre 2</b></sub>](https://github.com/user2) | [<img src="https://github.com/user3.png" width="50px;"/><br /><sub><b>Nombre 3</b></sub>](https://github.com/user3) |
| :---: | :---: | :---: |
...
[![Star History Chart](https://api.star-history.com/svg?repos=tu-usuario/tu-proyecto&type=Date)](https://star-history.com/#tu-usuario/tu-proyecto&Date)
